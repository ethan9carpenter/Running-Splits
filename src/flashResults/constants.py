...
specialSprint = ('55 M Hurdles', '60 M Hurdles', '100 M Hurdles', '110 M Hurdles')
specialDistance = ('2000 M Steeplechase', '3000 M Steeplechase')
relay = ('4x100', '4x200', '4x400', '4x400', '4x800', '4x1 Mile', 'Distance Medley', 
         '1600 Sprint Medley', 'Swedish Relay', '800 Sprint Medley')
crossCountry = ()

allRaces = sprints + distance + specialSprint + specialDistance + relay + crossCountry
...
columns = ('Place', 'Bib', 'Lane', 'Athlete', 'Affiliation', 'Time', 'Team', 'Reaction Time', 'Pl', 'Ln')
